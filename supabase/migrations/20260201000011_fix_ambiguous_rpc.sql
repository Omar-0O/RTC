-- Fix ambiguous function overload by dropping both potential variants
DROP FUNCTION IF EXISTS public.award_ethics_call_points(json);
DROP FUNCTION IF EXISTS public.award_ethics_call_points(jsonb);

-- Recreate the function with a single signature (using jsonb as best practice)
