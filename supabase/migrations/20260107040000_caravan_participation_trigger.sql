-- Trigger function to automatically log caravan participation
...
BEGIN
    ...
    IF NEW.is_volunteer = TRUE AND NEW.volunteer_id IS NOT NULL THEN
        ...
        -- Note: The existing trigger 'on_submission_approved' will update the volunteer's points
...
CREATE TRIGGER on_caravan_participant_added
    AFTER INSERT ON public.caravan_participants
    FOR EACH ROW
    EXECUTE FUNCTION public.log_caravan_participation();
