-- Update the view to include is_paid and reviewed_by for manual fines
...
-- 5. Manual Fines (from fine_types) - includes is_paid and reviewer info
SELECT
    s.volunteer_id,
...
LEFT JOIN profiles p ON s.reviewed_by = p.id
