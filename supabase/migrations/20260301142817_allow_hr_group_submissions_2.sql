-- Allow 'hr' to create group submissions and activity submissions
...
FOR INSERT
WITH CHECK (
  -- 1. Admin, Supervisor, Head HR, AND HR can create for ANY committee
  EXISTS (
  ...
  (
    ...
    OR
    -- Generic Committee Leader (must match profile committee)
    (
