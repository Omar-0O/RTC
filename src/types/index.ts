export type UserRole = 'volunteer' | 'supervisor' | 'admin' | 'committee_leader' | 'hr' | 'head_hr' | 'head_caravans' | 'head_events' | 'head_production' | 'head_fourth_year' | 'head_ethics' | 'head_quran' | 'head_marketing' | 'head_ashbal';
