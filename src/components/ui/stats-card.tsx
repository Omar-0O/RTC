...
export const StatsCard = memo(function StatsCard({
  ...
  if (variant === 'admin') {
    return (
      <Card className={cn('relative overflow-hidden', className)}>
        ...
        <CardContent className="!p-3 !pt-0 sm:!p-6 sm:!pt-0 flex flex-col items-center justify-center text-center gap-1 pb-4 sm:pb-6">
  ...
  return (
    <Card className={cn('relative overflow-hidden', className)}>
      ...
      <CardContent className="!p-3 !pt-0 sm:!p-6 sm:!pt-0 flex items-end justify-between gap-2">
